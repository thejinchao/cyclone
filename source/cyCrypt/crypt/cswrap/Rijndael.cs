...
/*
* copy from http://www.codeproject.com/Articles/1380/A-C-Implementation-of-the-Rijndael-Encryption-Decr
*/
...
namespace cyclone
{
    class Rijndael
    {
        ...
        public Rijndael(sbyte[] key)
        {
            ...
            for (int i = 0; i < KC; i++)
            {
                tk[i] = ((uint)(key[i * 4 + 0])) << 24;
                tk[i] |= ((uint)(key[i * 4 + 1])) << 16;
                tk[i] |= ((uint)(key[i * 4 + 2])) << 8;
                tk[i] |= ((uint)(key[i * 4 + 3])) << 0;
            }
            ...
            while (t < ROUND_KEY_COUNT)
            {
                ...
                tt = tk[KC - 1];
                tk[0] ^= ((uint)(sm_S[(tt >> 16) & 0xFF] & 0xFF)) << 24;
                tk[0] ^= ((uint)(sm_S[(tt >> 8) & 0xFF] & 0xFF)) << 16;
                tk[0] ^= ((uint)(sm_S[tt & 0xFF] & 0xFF)) << 8;
                tk[0] ^= (uint)(sm_S[(tt >> 24) & 0xFF] & 0xFF);
                tk[0] ^= ((uint)(sm_rcon[rconpointer++] & 0xFF)) << 24;
                for (int i = 1, j = 0; i < KC; )
                {
                    tk[i++] ^= tk[j++];
                }
                //Copy values into round key arrays
        ...
        private void _encryptBlock(byte[] _input, ref byte[] result, int offset)
        {
            uint t0 = (((uint)_input[0] << 24) | ((uint)_input[1] << 16) | ((uint)_input[2] << 8) | ((uint)_input[3] << 0)) ^ (uint)m_Ke[0, 0];
            uint t1 = (((uint)_input[4] << 24) | ((uint)_input[5] << 16) | ((uint)_input[6] << 8) | ((uint)_input[7] << 0)) ^ (uint)m_Ke[0, 1];
            uint t2 = (((uint)_input[8] << 24) | ((uint)_input[9] << 16) | ((uint)_input[10] << 8) | ((uint)_input[11] << 0)) ^ (uint)m_Ke[0, 2];
            uint t3 = (((uint)_input[12] << 24) | ((uint)_input[13] << 16) | ((uint)_input[14] << 8) | ((uint)_input[15] << 0)) ^ (uint)m_Ke[0, 3];
            ...
            for (int r = 1; r < ROUNDS; r++)
            {
                a0 = (sm_T1[(t0 >> 24) & 0xFF] ^
                    sm_T2[(t1 >> 16) & 0xFF] ^
                    sm_T3[(t2 >> 8) & 0xFF] ^
                    sm_T4[t3 & 0xFF]) ^ (uint)m_Ke[r, 0];

                a1 = (sm_T1[(t1 >> 24) & 0xFF] ^
                    sm_T2[(t2 >> 16) & 0xFF] ^
                    sm_T3[(t3 >> 8) & 0xFF] ^
                    sm_T4[t0 & 0xFF]) ^ (uint)m_Ke[r, 1];
                a2 = (sm_T1[(t2 >> 24) & 0xFF] ^
                    sm_T2[(t3 >> 16) & 0xFF] ^
                    sm_T3[(t0 >> 8) & 0xFF] ^
                    sm_T4[t1 & 0xFF]) ^ (uint)m_Ke[r, 2];
                a3 = (sm_T1[(t3 >> 24) & 0xFF] ^
                    sm_T2[(t0 >> 16) & 0xFF] ^
                    sm_T3[(t1 >> 8) & 0xFF] ^
                    sm_T4[t2 & 0xFF]) ^ (uint)m_Ke[r, 3];
            ...
            uint tt = m_Ke[ROUNDS, 0];
            result[offset++] = (byte)(sm_S[(t0 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_S[(t1 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_S[(t2 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_S[t3 & 0xFF] ^ tt);
            tt = m_Ke[ROUNDS, 1];
            result[offset++] = (byte)(sm_S[(t1 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_S[(t2 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_S[(t3 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_S[t0 & 0xFF] ^ tt);
            tt = m_Ke[ROUNDS, 2];
            result[offset++] = (byte)(sm_S[(t2 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_S[(t3 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_S[(t0 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_S[t1 & 0xFF] ^ tt);
            tt = m_Ke[ROUNDS, 3];
            result[offset++] = (byte)(sm_S[(t3 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_S[(t0 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_S[(t1 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_S[t2 & 0xFF] ^ tt);
        }

        //Convenience method to decrypt exactly one block of plaintext, assuming
        //Rijndael's default block size (128-bit).
        private void _decryptBlock(byte[] _input, ref byte[] result, int offset)
        {
            int in_offset = offset;
            uint t0 = (((uint)_input[in_offset++] << 24) | ((uint)_input[in_offset++] << 16) | ((uint)_input[in_offset++] << 8) | ((uint)_input[in_offset++] << 0)) ^ (uint)m_Kd[0, 0];
            uint t1 = (((uint)_input[in_offset++] << 24) | ((uint)_input[in_offset++] << 16) | ((uint)_input[in_offset++] << 8) | ((uint)_input[in_offset++] << 0)) ^ (uint)m_Kd[0, 1];
            uint t2 = (((uint)_input[in_offset++] << 24) | ((uint)_input[in_offset++] << 16) | ((uint)_input[in_offset++] << 8) | ((uint)_input[in_offset++] << 0)) ^ (uint)m_Kd[0, 2];
            uint t3 = (((uint)_input[in_offset++] << 24) | ((uint)_input[in_offset++] << 16) | ((uint)_input[in_offset++] << 8) | ((uint)_input[in_offset++] << 0)) ^ (uint)m_Kd[0, 3];
            ...
            for (int r = 1; r < ROUNDS; r++)
            {
                a0 = (sm_T5[(t0 >> 24) & 0xFF] ^
                    sm_T6[(t3 >> 16) & 0xFF] ^
                    sm_T7[(t2 >> 8) & 0xFF] ^
                    sm_T8[t1 & 0xFF]) ^ (uint)m_Kd[r, 0];

                a1 = (sm_T5[(t1 >> 24) & 0xFF] ^
                    sm_T6[(t0 >> 16) & 0xFF] ^
                    sm_T7[(t3 >> 8) & 0xFF] ^
                    sm_T8[t2 & 0xFF]) ^ (uint)m_Kd[r, 1];
                a2 = (sm_T5[(t2 >> 24) & 0xFF] ^
                    sm_T6[(t1 >> 16) & 0xFF] ^
                    sm_T7[(t0 >> 8) & 0xFF] ^
                    sm_T8[t3 & 0xFF]) ^ (uint)m_Kd[r, 2];
                a3 = (sm_T5[(t3 >> 24) & 0xFF] ^
                    sm_T6[(t2 >> 16) & 0xFF] ^
                    sm_T7[(t1 >> 8) & 0xFF] ^
                    sm_T8[t0 & 0xFF]) ^ (uint)m_Kd[r, 3];
            ...
            //Last Round is special
            uint tt = m_Kd[ROUNDS, 0];
            result[offset++] = (byte)(sm_Si[(t0 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_Si[(t3 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_Si[(t2 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_Si[t1 & 0xFF] ^ tt);
            tt = m_Kd[ROUNDS, 1];
            result[offset++] = (byte)(sm_Si[(t1 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_Si[(t0 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_Si[(t3 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_Si[t2 & 0xFF] ^ tt);
            tt = m_Kd[ROUNDS, 2];
            result[offset++] = (byte)(sm_Si[(t2 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_Si[(t1 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_Si[(t0 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_Si[t3 & 0xFF] ^ tt);
            tt = m_Kd[ROUNDS, 3];
            result[offset++] = (byte)(sm_Si[(t3 >> 24) & 0xFF] ^ (tt >> 24));
            result[offset++] = (byte)(sm_Si[(t2 >> 16) & 0xFF] ^ (tt >> 16));
            result[offset++] = (byte)(sm_Si[(t1 >> 8) & 0xFF] ^ (tt >> 8));
            result[offset++] = (byte)(sm_Si[t0 & 0xFF] ^ tt);

        }

        //Auxiliary Function
        private void _xor(ref byte[] out_buf, byte[] in_buf, int out_offset, int in_offset)
        {
            for (int i = 0; i < BLOCK_SIZE; i++)
            {
                out_buf[i + out_offset] ^= in_buf[i + in_offset];
            }
        }
        ...
        private static readonly int BC = 4;
        private static readonly int KC = 4;

    	//Encryption (m_Ke) round key
        private uint[,] m_Ke = new uint[ROUNDS + 1, BC];
        //Decryption (m_Kd) round key
        private uint[,] m_Kd = new uint[ROUNDS + 1, BC];

        private static readonly byte[] sm_S =
        {
        ...
        private static readonly byte[] sm_Si =
        {
        ...
        private static readonly uint[] sm_T1 =
        {
        ...
        private static readonly uint[] sm_T2 = 
        {
        ...
        private static readonly uint[] sm_T3 = 
        {
        ...
        private static readonly uint[] sm_T4 = 
        {
        ...
        private static readonly uint[] sm_T5 = 
        {
        ...
        private static readonly uint[] sm_T6 = 
        {
        ...
        private static readonly uint[] sm_T7 = 
        {
        ...
        private static readonly uint[] sm_T8 = 
        {
        ...
        private static readonly uint[] sm_U1 = 
        {
        ...
        private static readonly uint[] sm_U2 = 
        {
        ...
        private static readonly uint[] sm_U3 = 
        {
        ...
        private static readonly uint[] sm_U4 = 
        {
        ...
        private static readonly byte[] sm_rcon =
        {
